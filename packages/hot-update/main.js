...
(function () {
    if (typeof window.jsb === 'object') {
        var hotUpdateSearchPaths = localStorage.getItem('HotUpdateSearchPaths-game');
...
module.exports = {
    load: function () {
        // Execute when the package is loaded correctly
    },

    unload: function () {
        // Execute when the package is properly uninstalled
    },
